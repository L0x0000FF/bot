...
void BSP_TIM_Init() {
  ...
  tim_ports[3].phtim = &htim3;
  tim_ports[3].channel = TIM_CHANNEL_2;

  tim_ports[4].phtim = &htim5;
  tim_ports[4].channel = TIM_CHANNEL_1;

  tim_ports[5].phtim = &htim8;
  tim_ports[5].channel = TIM_CHANNEL_2;

  tim_ports[6].phtim = &htim13;
  tim_ports[6].channel = 0;  // Not a PWM port
